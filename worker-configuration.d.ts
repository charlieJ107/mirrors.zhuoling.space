/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3595dd2fafdc016927e7e98590d7c9a2)
// Runtime types generated with workerd@1.20260921.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	MIRROR_HOT: R2Bucket;
	MIRROR_COLD: R2Bucket;
	ROBOT_APT: R2Bucket;
	DB: D1Database;
	MIRROR_ANALYTICS: AnalyticsEngineDataset;
	ASSETS: Fetcher;
	...
	DATABASE_URL: string;
	PORT: string;
	INGEST_WORKFLOW: Workflow<Parameters<import("./src/server/entry.cloudflare").IngestWorkflow['run']>[0]['payload']>;
	VERIFY_WORKFLOW: Workflow<Parameters<import("./src/server/entry.cloudflare").VerifyWorkflow['run']>[0]['payload']>;
	TIER_WORKFLOW: Workflow<Parameters<import("./src/server/entry.cloudflare").TierWorkflow['run']>[0]['payload']>;
	GC_WORKFLOW: Workflow<Parameters<import("./src/server/entry.cloudflare").GcWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/entry.cloudflare");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_ALLOWED_HOSTS" | "BETTER_AUTH_OIDC_CLIENT_ID" | "BETTER_AUTH_OIDC_CLIENT_SECRET" | "BETTER_AUTH_OIDC_DISCOVERY_URL" | "DATABASE_URL" | "PORT">> {}
}
